...
/**
 * Servlet implementation class GenRepCredConsumoServlet
 */
public class GenRepCredConsumoServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GenRepCredConsumoServlet() {
        super();
	...
	protected void procesar(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException {
        ...
        try {
			...
			JasperReport reporte = (JasperReport) JRLoader.loadObject(this.getClass().getClassLoader().getResourceAsStream(parameters.getKey("REPORTE_CREDITO_CONSUMO")));
			
			/* CARGA PARAMETROS DEL REPORTE*/
			Map paramReporte = jasperServiceImpl.getParamReporCredConsumo(creditoCabeceraBO, creditoCronogramaBO);
