...
/**
 * Servlet implementation class GenCronoAgriServlet
 */
public class GenCronoAgriServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GenCronoAgriServlet() {
        super();
	...
	private void procesar(HttpServletRequest request,
		...
		try{
			...
			if (creditoCronogramaBO.isPeriodoGracia()){
				dispatcher = getServletContext().getRequestDispatcher(ResponsePage.PAGE_CRED_AGRI_GRACIA);
			}else{
				dispatcher = getServletContext().getRequestDispatcher(ResponsePage.PAGE_CRED_AGRI);
			}
