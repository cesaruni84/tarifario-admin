 ...
 *
 */
public class AhorroSimuladorManager implements DepositoInterface{
	...
	public DepositoSimulacion generarSimulacion(String jsonRequest, String idSubProducto) {
		...
		try {
			...
			//Obtiene TREA de base de datos: toma el valor promedio
			...
			datosDeposito.setValorITF(ITF);
			
			// Genera Cronograma-Deposito con los datos enviados
			depositoSimulacion = depositoServiceImpl.doSimulacionAhorros(datosDeposito);
