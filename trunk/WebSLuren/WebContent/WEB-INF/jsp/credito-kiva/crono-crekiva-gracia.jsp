																...
																<td>
																	...
																	<div id="opciones_productos" style="margin-top:10px">
																		...
																		<ul id="nav">
																			...
																			<!--Credito KIVA-->
																			<li class="top"><a href="#" id="btnCreKIVA" class="top_link"><span class="down"><img src="imagenes/calculadora/btn_cred_kiva_b.jpg" width="80" border="0" onmouseover="this.src='imagenes/calculadora/btn_cred_kiva_b.jpg'" onmouseout="this.src='imagenes/calculadora/btn_cred_kiva_b.jpg'"/></span></a>
																				<ul class="sub">
