												...
												<tr>
													...
													<!--Seccion con panel de datos para el calculo de credito-->																
														<div id="panel-control" style="margin-top:-120px;">														
															...
															<div id="panel-resumen" style="margin-left:10px">
																...
																<table style=";margin-right:81px">
																	<tr>
																		<td width="120"><label for="subProducto_res" style="float:right;"><b>Sub-Producto :<br> </label></td>
																		<td width="30"></td>
																	...
																	<tr>
																		<td><label for="moneda_res" style="float:right;"><b>Moneda: <br></label></td>
																		<td></td>
																	...
																	<tr>
																		<td><label for="montoDeposito_res" style="margin-top:5px;float:right;"><b>Monto: <br></label></td>
																		<td></td>
																		<td><input type="text" name="montoDeposito_res" id="montoDeposito_res" size="30" class="text ui-widget-content" value="<%=request.getAttribute("montoDeposito")%>" style="border:none"></td>
																	</tr>
																	
																	<tr>
																		<td><label for="ITFDeposito_res" style="float:right;"><b>ITF Depósito: <br></label></td>
																		<td></td>
																		<td><input type="text" name="ITFDeposito_res" id="ITFDeposito_res" size="30" class="text ui-widget-content" value="<%=request.getAttribute("ITFDeposito")%>" style="border:none"></td>
																	</tr>

																	<tr>	
																		<td><label for="plazoDeposito_res" style="float:right;"><b>Plazo (días):<br> </label></td>
																		<td></td>
																	...
																	<tr>
																		<td><label for="valorTREA_res" style="float:right;"><b>TREA (%):<br></label></td>
																		<td></td>
																		<td><input type="text" name="valorTREA_res" id="valorTREA_res" size="30" class="text ui-widget-content" value="<%=request.getAttribute("valorTREA")%>" style="margin-bottom:5px;border:none"/></td>
																	</tr>
																	...
																	<tr>
																		<td><label for="ITFRetiro_res" style="float:right;"><b>ITF Retiro: <br></label></td>
																		<td></td>
																		<td><input type="text" name="ITFRetiro_res" id="ITFRetiro_res" size="30" class="text ui-widget-content" value="<%=request.getAttribute("ITFRetiro")%>" style="border:none"></td>
																	</tr>
																...
																<div id="opciones-simulador" align="center" style="margin-right:100px;margin-bottom:20px">
														...
														<div style="margin-top:20px;margin-bottom:20px;margin-left:10px">
															<label style="color:red;"> Notas:<br>
																	- Monto mínimo de apertura S/. 20.00 ó US$ 10.00.<br>
																	- El simulador contempla como supuesto que el cliente mantiene en su cuenta un saldo promedio mensual mayor a s/100.00 o $50.00
															</label>
														</div>
