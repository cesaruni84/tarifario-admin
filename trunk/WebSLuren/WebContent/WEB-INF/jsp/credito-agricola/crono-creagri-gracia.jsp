																...
																<td>
																	...
																	<div id="opciones_productos" style="margin-top:10px">
																		...
																		<ul id="nav">
																			...
																			<!--Credito Agrícola-->
																			<li class="top"><a href="#" id="btnCreAgri" class="top_link"><span class="down"><img src="imagenes/calculadora/btn_cred_agricola_b.jpg" width="80" border="0" onmouseover="this.src='imagenes/calculadora/btn_cred_agricola_b.jpg'" onmouseout="this.src='imagenes/calculadora/btn_cred_agricola_b.jpg'"/></span></a>									
