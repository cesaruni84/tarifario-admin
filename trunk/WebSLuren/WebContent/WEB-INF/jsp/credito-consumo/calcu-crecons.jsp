...
<script>
	$(document).ready(function(){
		...
		//Obtiene nemonico de sub producto seleccionado 
		var nemonico = $.getURLParam("nemSubProducto");
		if (nemonico == 'DPLA'){
			...
			$.ajax({
				...
				success : function(response) {
					...
					if(codigo == 0){
						...
						window.location.href =  './generarCronogramaServlet?jsonRequest='+ json;
					}else{
						alert(mensaje);	
					}	
				},
															...
															<div id="panel-datos" style="margin-left:25px;margin-top:-200px">	
																<form method="post" id="formulario" name="formulario">
																	...
																	<table width="750" border="0" cellspacing="0" cellpadding="0">
																		...
																		<tr>
																			<td width="150"><label for="montoCredito" style="margin-top:5px;float:left"><b>Monto: <br></label></td>
																			<td width="60"><input type="text" name="montoCredito" id="montoCredito" size="30" maxlength="12" class="requeried montoCredito text ui-widget-content"/></td>
																			<td></td>
																		</tr>
																		<tr>
