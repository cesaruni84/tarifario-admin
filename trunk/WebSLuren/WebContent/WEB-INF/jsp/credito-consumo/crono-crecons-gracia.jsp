...
<script>
	$(document).ready(function(){
		...
		$('#valorTasa_res').attr("disabled", true);
		...
		$( "#opciones-imprimir" ).dialog({
			...
			buttons: {
				"PDF": function() {
					...
					window.location.href='./genRepCredConsumoServlet';
				},
				"Impresora": function() {
																...
																<td>
																	...
																	<div id="opciones_productos" style="margin-top:10px">
																		...
																		<ul id="nav">
																			...
																			<!--Credito Consumo-->
																			<li class="top"><a href="#" id="btnCreConsu" class="top_link"><span class="down"><img src="imagenes/calculadora/btn_cred_consumo_b.jpg" width="80" border="0" onmouseover="this.src='imagenes/calculadora/btn_cred_consumo_b.jpg'" onmouseout="this.src='imagenes/calculadora/btn_cred_consumo_b.jpg'"/></span></a>
															...
															<div id="panel-resumen" style="margin-left:22px">
																...
																<table style="margin-right:81px">
																	...
																	<tr>
																		...
																		<td><label for="tipoPersona_res" style="float:left;"><b>Tipo Persona: <br></label></td>
																...
																<table id="tablaCronograma" border="0" cellpadding="4" cellspacing="0" align="center" width="100%">
																	...
																	<%
																		...
																		while (iter.hasNext()) {
																			...
																			//ITF
																			valor = valor + "<td align='center'>"+  cuota.getValorITFCuota() + "</td>";
