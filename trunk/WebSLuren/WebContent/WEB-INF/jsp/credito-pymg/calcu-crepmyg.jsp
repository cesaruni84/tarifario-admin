			...
			$.ajax({
				...
				success : function(response) {
					...
					if(codigo == 0){
						...
						window.location.href =  './genCronoPMYGServlet?jsonRequest='+ json;
					}else{
						alert(mensaje);	
					}	
				},
																...
																<td>
																	...
																	<div id="opciones_productos">
																		...
																		<ul id="nav">
																			...
																			<!--Credito PYMG-->
																			<li class="top"><a href="#" id="btnCrePMYG" class="top_link"><span class="down"><img src="imagenes/calculadora/btn_cred_pmyg_b.jpg" width="80" onmouseover="this.src='imagenes/calculadora/btn_cred_pmyg_b.jpg'" border="0" onmouseout="this.src='imagenes/calculadora/btn_cred_pmyg_b.jpg'"/></span></a>
																				<ul class="sub" style="margin-top:50px">
