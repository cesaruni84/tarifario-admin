...
//			echo  $diferencia.'-----'.$var14.'---'.$total_amort_cap.'----'.$prorrateo.'++<br />';				
...
/*				$_scapital = $arr_saldo_cap[$i-1] - ($d_sum_ven * ($i-1));
				...
				$_scapital = $arr_saldo_cap[($i-1)+$incremento_matriz];
				echo number_format($_scapital,2);
...
//			echo number_format($_total_amortizacion_de_interes,2);
			...
			$valores_a_sumar =  str_replace(",","", $d_sum_ven) + str_replace(",","", $arr_amort_capital[($i-1)+$incremento_matriz]);
