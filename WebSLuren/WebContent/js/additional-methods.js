...
jQuery.validator.addMethod("nombre", function(value, element, params) {
...
jQuery.validator.addMethod('lessThanEqualDouble', function(value, element, param) {
    return this.optional(element) || parseDouble(value) <= parseDouble($(param).val());
