...
<script>
	$(document).ready(function(){
		...
		$('#valorInmueble_res').attr("disabled", true);
		$('#montoCredito_res').attr("disabled", true);
		$('#bonoHipotecario_res').attr("disabled", true);
		$('#totalRecibir_res').attr("disabled", true);
		...
		$('#seguroInmueble_res').attr("disabled", true);
		$('#totalIntereses').attr("disabled", true);
		$('#valorTCEA_res').attr("disabled", true);
		$('#valorCuota_res').attr("disabled", true);
		$('#valorCuotaSinBono_res').attr("disabled", true);
		$('#tipoGracia_res').attr("disabled", true);
		$('#totalIntereses_res').attr("disabled", true);
		$('#total_SegDesgv').attr("disabled", true);
		$('#total_SegRiesgo').attr("disabled", true);
		...
		$( "#opciones-imprimir" ).dialog({
			...
			buttons: {
				"PDF": function() {
					...
					window.location.href='./genRepCredHipoServlet';
				},
				"Impresora": function() {
																...
																<td>
																	...
																	<div id="opciones_productos" style="margin-top:10px">
																		...
																		<ul id="nav">
																			...
																			<!--Credito Hipotecario-->
																			<li class="top"><a href="#" id="btnCreHipo" class="top_link"><span class="down"><img src="imagenes/calculadora/btn_cred_hipotecario_b.jpg" width="80" border="0" onmouseover="this.src='imagenes/calculadora/btn_cred_hipotecario_b.jpg'" onmouseout="this.src='imagenes/calculadora/btn_cred_hipotecario_b.jpg'"/></span></a>									
														...
														<div id="panel-control" style="margin-top:-120px;">														
															...
															<div id="panel-resumen" style="margin-left:22px">
																...
																<table style="margin-right:20px">
																	<tr>
																		<td width="250"><label for="subProducto_res" style="float:left;"><b>Sub-Producto :<br> </label></td>
																		<td><input type="text" name="subProducto_res" id="subProducto_res" size="30" class="text ui-widget-content" value="<%=request.getAttribute("subProducto")%>" style="margin-bottom:5px;border:none"/></td>
																	...
																	<tr>
																		<td><label for="numCuotas_res" style="float:left;"><b>Plazo (meses) :<br> </label></td>
																	...
																	<tr>
																		...
																		<td><label for="tipoGracia_res" style="float:left;"><b>Tipo Periodo Gracia :<br> </label></td>
																		<td><input type="text" name="tipoGracia_res" id="tipoGracia_res" size="30" class="text ui-widget-content" value="<%=request.getAttribute("tipoPeriodoGracia")%>" style="margin-bottom:5px;border:none"/></td>
																		<td><label for="seguroInmueble_res" style="float:left;"><b>Seguro Todo <br>Riesgo (%) : <br></label></td>
																		<td><input type="text" name="seguroInmueble_res" id="seguroInmueble_res" size="30" class="text ui-widget-content" value="<%=request.getAttribute("seguroTodoRiesgo")%>" style="margin-bottom:5px;border:none"></td>
																	...
																	<tr>
																		<td><label for="valorCuota_res" style="float:left;"><b>Cuota Aprox.con Bono :<br> </label></td>
																		<td><input type="text" name="valorCuota_res" id="valorCuota_res" size="30" class="text ui-widget-content" value="<%=request.getAttribute("valorCuota")%>" style="margin-bottom:5px;border:none"/></td>
																		<td><label for="valorCuotaSinBono_res" style="float:left;"><b>Cuota Aprox.sin Bono :<br></label></td>
																		<td><input type="text" name="valorCuotaSinBono_res" id="valorCuotaSinBono_res" size="30" class="text ui-widget-content" value="<%=request.getAttribute("valorCuotaSinBono")%>" style="margin-bottom:5px;border:none"></td>
																	</tr>
																...
																<table>
																	<tr>
																		<td><label for="totalIntereses_res" style="float:left;"><b>Intereses:<br> </label></td>
																		<td><input type="text" name="totalIntereses_res" id="totalIntereses_res" size="20" class="text ui-widget-content" value="<%=request.getAttribute("totalIntereses")%>" style="margin-bottom:5px;border:none"/></td>
																		<td><label for="total_SegDesgv" style="float:left;"><b>Seg. Desgravamen :<br></label></td>
																		<td><input type="text" name="total_SegDesgv" id="total_SegDesgv" size="20" class="text ui-widget-content" value="<%=request.getAttribute("totalSegDesgravamen")%>" style="margin-bottom:5px;border:none"></td>
																		<td><label for="total_SegRiesgo" style="float:left;"><b>Seg. Todo Riesgo :<br></label></td>
																		<td><input type="text" name="total_SegRiesgo" id="total_SegRiesgo" size="20" class="text ui-widget-content" value="<%=request.getAttribute("totalSegRiesgo")%>" style="margin-bottom:5px;border:none"></td>
																	</tr>
																</table>
																
																<div id="opciones-cronograma" style="float:right;margin-right:15px;margin-top:15px">
															...
															<div id="panel-cronograma">
																<table id="tablaCronograma" border="0" cellpadding="4" cellspacing="0" align="center" width="100%">
																	<thead>
																		...
																		<th align="center" width="60">SEG. TODO RIESGO</th>
																	...
																	<tr>
																		...
																		<td align="center"><%=request.getAttribute("fechaDesembolso")%></td>
																		<td align="center"><%=request.getAttribute("totalRecibir")%></td>
																		<td></td>
																		<td></td>
																		<td></td>
																		<td></td>
																	...
																	<%
																		...
																		while (iter.hasNext()) {
																			...
																			//Seg. Todo Riesgo
																			valor = valor + "<td align='center'>"+  Utilitario.formatearMontosMiles(cuota.getSeguroTodoRiesgo(), Constantes.FORMATO_MONTOS_VISTA)  + "</td>";
																	...
																	<thead>
																		...
																		<th align="center" width="60"><% out.println(request.getAttribute("totalSegRiesgo"));%></th>
