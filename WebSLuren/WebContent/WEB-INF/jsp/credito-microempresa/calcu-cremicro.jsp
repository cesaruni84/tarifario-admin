...
<script>
	$(document).ready(function(){
		...
		//Obtiene id del Centro Comercial
		//idLocal = $.getURLParam("subProducto");
		...
		$('#seguroTodoRiesgo').attr("checked","checked");
		...
		var reglas = {  
			 ...
			 numCuotas: {required:true, number:true, min:1, max: 48},
		...
		$("#idBtnCrePYMG").click(function(){
			...
			object.periodoPago =$("#formaPago").val();
			object.formaPago = $("#formaPago option:selected").text();
			...
			$.ajax({
				...
				success : function(response) {
					...
					if(codigo == 0){
						...
						window.location.href =  './genCronoMicroServlet?jsonRequest='+ json;
					}else{
						alert(mensaje);	
					}	
				},
																...
																<td>
																	...
																	<div id="opciones_productos">
																		...
																		<ul id="nav">
																			...
																			<li class="top"><a href="#" id="btnCreMicro" class="top_link"><span class="down"><img src="imagenes/calculadora/btn_cred_microempresa_b.jpg" width="80" onmouseover="this.src='imagenes/calculadora/btn_cred_microempresa_b.jpg'" border="0" onmouseout="this.src='imagenes/calculadora/btn_cred_microempresa_b.jpg'"/></span></a>
															...
															<div id="panel-datos" style="margin-left:25px;margin-top:-200px">		
																<form method="post" id="formulario" name="formulario">
																	...
																	<table width="750" border="0" cellspacing="0" cellpadding="0">
																		...
																		<tr>
																			<td width="240"><label for="montoCredito"  style="margin-top:5px;float:left"><b>Monto: <br></label></td>
																		...
																		<tr>
																			<td><label for="tipoPersona" style="float:left"><b>Tipo
																						Persona: <br></label></td>
																		...
																		<tr>
																			...
																			<td><input type="text" name="numCuotas" id="numCuotas" size="30" maxlength="2" class="required numCuotas text ui-widget-content" style="margin-bottom:5px;"/></td>
																			<td></td>
																		</tr>
																		...
																		<tr>
																			<td><label for="diasGracia" style="float:left"><b>Periodo de Gracia (0-30-60-180 dias):</label></td>
																		...
																		<tr>
																			<td><label for="divinoSeguro" style="float:left"><b>Divino Seguro: <br><br></label></td>
																			<td>
																				<select name="divinoSeguro" id="divinoSeguro" class="text ui-widget-content" style="margin-top:-14px;height:25px; width:210px;color:#039;font-family:Arial, Helvetica, sans-serif;">
																		...
																		<tr>
																			...
																			<td><select name="formaPago" id="formaPago"
																				class="text ui-widget-content"
																				style="margin-bottom:5px;height: 25px; width: 210px; color:#039; font-family: Arial, Helvetica, sans-serif;">
																					<option value="30" selected="selected">Mensual (30 dias)</option>
																		...
																		<tr height="10">
																			...
																			<td>
																				<div id="panel-botones"  style="margin-bottom:20px;margin-top:20px;float:left">
																					<a id="idBtnCrePYMG" href="#" ><img src="imagenes/calculadora/btn_calcular_a.jpg" width="100" border="0" onmouseover="this.src='imagenes/calculadora/btn_calcular_b.jpg'" onmouseout="this.src='imagenes/calculadora/btn_calcular_a.jpg'"></a>
																				</div>
																			</td>
																			<td></td>
																		</tr>
