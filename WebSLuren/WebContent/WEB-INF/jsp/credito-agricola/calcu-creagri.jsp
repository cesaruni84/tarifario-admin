			...
			$.ajax({
				...
				success : function(response) {
					...
					if(codigo == 0){
						...
						window.location.href =  './genCronoAgriServlet?jsonRequest='+ json;
					}else{
						alert(mensaje);	
					}	
				},
																...
																<td>
																	...
																	<div id="opciones_productos">
																		...
																		<ul id="nav">
																			...
																			<!--Credito Agrícola-->
																			<li class="top"><a href="#" id="btnCreAgri" class="top_link"><span class="down"><img src="imagenes/calculadora/btn_cred_agricola_b.jpg" width="80" onmouseover="this.src='imagenes/calculadora/btn_cred_agricola_b.jpg'" border="0" onmouseout="this.src='imagenes/calculadora/btn_cred_agricola_b.jpg'"/></span></a>
																				<ul class="sub" style="margin-top:50px">
