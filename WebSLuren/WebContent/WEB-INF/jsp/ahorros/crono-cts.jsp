														...
														<div id="panel-control" style="margin-top:-120px;">														
															...
															<div id="panel-resumen" style="margin-left:10px">
																...
																<table style=";margin-right:81px">
																	<tr>
																		<td width="200"><label for="subProducto_res" style="float:right"><b>Sub-Producto :<br> </label></td>
																	...
																	<tr>
																		<td><label for="montoDeposito_res" style="margin-top:5px;float:right"><b>Monto: <br><br></label></td>
																	...
																	<tr>
																		<td><label for="moneda_res" style="margin-top:5px;float:right;"><b>Moneda: <br></label></td>
																		<td><input type="text" name="moneda_res" id="moneda_res" size="30"  class="text ui-widget-content" value="<%=request.getAttribute("moneda")%>" style="border:none;float:center;"></td>
																...
																<br><br>
																<div id="opciones-simulador" style="margin-right:100px;margin-bottom:20px">
