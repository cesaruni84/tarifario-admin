...
<%@ page import="org.srluren.web.services.impl.TasaServicesImpl"%>
<%@ page import="org.srluren.web.beans.hb.SubProducto"%>
<%@ page import="org.srluren.web.beans.hb.Producto"%>
<%@ page import="org.srluren.web.beans.hb.Plazo"%>
...
<script>
	$(document).ready(function(){
		...
		var reglas = {  
			 ...
			 fechaInicio:{required:true, australianDate:true},  
		}; 
		
		var mensajes = {  
			importeDeposito: {number:"Importe del depósito inválido, solo debe ingresar números"},  
			fechaInicio:{australianDate:"Debe ingresar una fecha válida"},  
		}; 
		...
		//Segun la moneda y el tipo de persona carga combo de plazos
		$("#moneda").change(function() {
			
			//Limpia valores de combo de Plazos
			$('#plazoDeposito').html("");
			...
			//Obtiene combo de plazos del servidor
			$.ajax({
				type: 'get',
				data : "idMoneda="+idMoneda + "&" + "idTipoPersona="+idTipoPersona,
				url : './listarPlazosServlet',
				success : function(hmtlComboPlazos_) {
					//Añade html dinamico con valores de subproducto
					$("#plazoDeposito").append(hmtlComboPlazos_);
				},
				error : function(mensaje_error_) {
					alert(mensaje_error_);
				}
			});
		});
		...
		$("#tipoPersona").change(function() {
			...
			$.ajax({
				...
				data : "idMoneda="+idMoneda + "&" + "idTipoPersona="+idTipoPersona,
				url : './listarPlazosServlet',
				success : function(hmtlComboPlazos) {					
					//Añade html dinamico con valores de subproducto
					$("#plazoDeposito").append(hmtlComboPlazos);	
				},
		...
		//Evento seleccionar plazo
		$("#plazoDeposito").change(function() {
			
			//Obtiene plazo seleccionado
			var plazo = $("#plazoDeposito").val();
			alert('El cálculo se realizará en base a ' + plazo + ' días'  );
		});
		...
		$("#btnAhorro").click(function(){
			...
			object.fechaInicio =$("#fechaInicio").val();
			object.formaPagoIntereses =$("#formaPagoIntereses").val();
			
			//Convierte a formato JSON
			var json = JSON.stringify(object);

			//Envia informacion al servidor para generar el cronograma
			window.location.href =  './genSimDplzoServlet?jsonRequest='+ json;	
...
<body>
	<div align="center">
		...
		<%
			...
			System.out.println(subProducto.getIdSubProducto());
																...
																<form method="post" id="formulario" name="formulario">
																	...
																	<table width="750" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px">
																		...
																		<tr>
																			...
																			<td><input type="text" name="subProducto" id="subProducto" size="30" class="text ui-widget-content" value="<%=request.getSession().getAttribute("nombreSubProducto")%>" style="margin-top:5px;border:none"/></td>
																			<td></td>
																		</tr>
																	
																		<tr>
																			<td width="200"><label for="importeDeposito" style="float:left"><b>Importe a Depositar :<br></label></td>
																			<td><input type="text" name="importeDeposito" id="importeDeposito" size="30" style="margin-top:5px;" maxlength="12"  class="required importeDeposito text ui-widget-content"/></td>
																			<td></td>
																		</tr>
																		...
																		<tr>
																			...
																			<td align="left"><select name="moneda" id="moneda"
																				...
																				style="margin-top:3px;height: 25px; width: 210px; color: #039; font-family: Arial, Helvetica, sans-serif;">
																		...
																		<tr>
																			<td><label for="fechaInicio" style="float:left"><b>Fecha de Inicio: <br></label></td>
																			<td><input type="text" name="fechaInicio" id="fechaInicio" size="30" maxlength="10" class="required fechaInicio text ui-widget-content" style="margin-top:7px;"/></td>
																			<td></td>
																		</tr>
																		...
																		<tr>
																			...
																			<td><select name="tipoPersona" id="tipoPersona" class="text ui-widget-content" style="height: 25px; width: 210px; color:#039; font-family: Arial, Helvetica, sans-serif;">
																		...
																		<tr>
																			<td><label for="plazoDeposito" style="float:left"><b>Plazo : <br> </label></td>
																			<td><select name="plazoDeposito" id="plazoDeposito" class="text ui-widget-content" style="margin-top:8px;height: 25px; width: 210px; color:#039; font-family: Arial, Helvetica, sans-serif;">
																			...
																			<%
																				...
																				List<Plazo> lista = tasaServicesImpl.listarPlazosxSubProducto(idSubProducto, "1", "1");
																		...
																		<tr>
																			<td><label for="formaPagoIntereses" style="float:left"><b>Forma de Pago Intereses: <br></label></td>
																			<td><select name="formaPagoIntereses" id="formaPagoIntereses"class="text ui-widget-content" style="margin-top:8px;height: 25px; width: 210px; color:#039; font-family: Arial, Helvetica, sans-serif;">
																					<option value="1" selected="selected">Al final del Plazo</option>
