...
/**
 * Servlet implementation class GenerarCronograma
 */
public class GenerarCronograma extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GenerarCronograma() {
        super();
	...
	private void procesar(HttpServletRequest request,
		...
		if (creditoCronogramaBO.isPeriodoGracia()){
			dispatcher = getServletContext().getRequestDispatcher(ResponsePage.PAGE_CRED_CONS_GRACIA);
		}else{
			dispatcher = getServletContext().getRequestDispatcher(ResponsePage.PAGE_CRED_CONS);
		}
