...
/**
 * Servlet implementation class GenCronoPMYGServlet
 */
public class GenCronoPMYGServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GenCronoPMYGServlet() {
        super();
	...
	private void procesar(HttpServletRequest request,
		...
		if (creditoCronogramaBO.isPeriodoGracia()){
			dispatcher = getServletContext().getRequestDispatcher(ResponsePage.PAGE_CRED_PYMG_GRACIA);
		}else{
			dispatcher = getServletContext().getRequestDispatcher(ResponsePage.PAGE_CRED_PYMG);
		}
