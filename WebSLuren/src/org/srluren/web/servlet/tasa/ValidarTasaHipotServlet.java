...
/**
 * Servlet implementation class ValidarTasaHipotServlet
 */
public class ValidarTasaHipotServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ValidarTasaHipotServlet() {
        super();
	...
	private void procesar(HttpServletRequest request,HttpServletResponse response) {
		...
		try {
			...
			String plazo			= json.get("plazoPrestamo").toString();
