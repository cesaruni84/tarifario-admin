...
/**
 * Servlet implementation class ValidarMontosHipoTePPServlet
 */
public class ValidarMontosHipoTePPServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ValidarMontosHipoTePPServlet() {
        super();
